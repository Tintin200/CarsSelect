                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaChip(label: '1899', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'Généraliste', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Fiat, fondée en 1899 à Turin, est la marque automobile italienne la plus populaire. Connue pour ses citadines emblématiques comme la 500, elle a démocratisé l'automobile en Italie et en Europe. Aujourd'hui intégrée au groupe Stellantis, Fiat mise sur l'électrique tout en conservant son caractère joyeux et accessible.",
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: FontWeight.w300,
                        letterSpacing: 0.3,
                        color: Color(0xFF1A1714).withOpacity(0.75),
                      ),
                    ),
                  ),
                  const SizedBox(height: 48),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1899',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'IT',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Généraliste', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
