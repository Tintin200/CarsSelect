              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      _MetaChip(label: 'Italie', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: '1992', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'Hypercar', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Pagani est un constructeur automobile artisanal fondé en 1992 par Horacio Pagani en Italie. Avec ses hypercars comme la Zonda et la Huayra, fabriquées à la main en très petite série, Pagani représente l'ultime alliance entre art et ingénierie. Chaque véhicule est une sculpture mécanique d'une rareté et d'une précision absolues.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1992',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'IT',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Hypercar', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
