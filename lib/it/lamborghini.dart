              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/it/lamborghini.png',
                      width: 140,
                      height: 80,
                      fit: BoxFit.contain,
                    ),
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaChip(label: '1963', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'Supercar', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Lamborghini est une marque italienne fondée en 1963 par Ferruccio Lamborghini, rival légendaire de Ferrari. Avec ses supercars au design radical et aux performances extrêmes comme l'Huracán et l'Urus, elle incarne l'excès assumé et le génie technique. Membre du groupe Volkswagen, Lamborghini entre dans l'ère hybride et électrique.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1963',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'IT',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Supercar', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
