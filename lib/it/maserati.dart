                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaChip(label: '1914', greyColor: _grey),
                      _MetaDot(color: _divider),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Maserati est une marque italienne de prestige fondée en 1914 à Bologne. Avec son trident emblématique, elle incarne le luxe sportif à l'italienne. Connue pour des modèles comme la Ghibli, le Levante et la MC20, Maserati opère aujourd'hui une transformation vers l'électrique tout en préservant son caractère unique et exclusif.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1914',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'IT',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Luxe', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
