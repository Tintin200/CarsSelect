                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaChip(label: '1948', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'Sport', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Lotus est une marque britannique mythique fondée en 1948 par Colin Chapman, dont la philosophie repose sur la légèreté et la performance pure. Pionnière en Formule 1, elle a révolutionné l'ingénierie automobile. Aujourd'hui sous propriété Geely, Lotus se réinvente avec des hypercars électriques tout en honorant son héritage sportif.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1948',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'UK',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Sport', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
