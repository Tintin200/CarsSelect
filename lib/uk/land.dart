                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'SUV', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Land Rover est une marque britannique fondée en 1948, pionnière du SUV tout-terrain premium. Avec des modèles iconiques comme le Defender, le Discovery et le Range Rover, elle allie capacités off-road exceptionnelles et luxe raffiné. Membre du groupe Tata Motors, Land Rover développe activement ses gammes électriques et hybrides.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'SUV', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
