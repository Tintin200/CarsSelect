                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      ...
                      _MetaChip(label: '1906', greyColor: _grey),
                      _MetaDot(color: _divider),
                      _MetaChip(label: 'Ultra-luxe', greyColor: _grey),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Rolls-Royce est la quintessence du luxe automobile, fondée en 1906 par Charles Rolls et Henry Royce. Avec la Spirit of Ecstasy comme emblème, chaque véhicule est entièrement fabriqué à la main à Goodwood. Membre du groupe BMW, Rolls-Royce incarne le summum du prestige mondial avec des modèles comme la Phantom, la Ghost et le Cullinan électrique.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const _StatBox(value: '1906',    label: 'FONDATION', gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'UK',    label: 'PAYS',      gold: _gold, grey: _grey, divider: _divider),
                        Container(width: 1, height: 60, color: _divider),
                        const _StatBox(value: 'Ultra-luxe', label: 'SEGMENT',   gold: _gold, grey: _grey, divider: _divider),
                      ],
                    ),
                  ),
